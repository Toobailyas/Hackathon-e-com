export default function Signup(){
    ...
    <section className="text-gray-600 bg-[#F9F9F9] font-[Santoshi] body-font">
      <div className="container px-5 py-10 mx-auto bg-[#FFFFFF]">
        ...
        <div className="flex lg:w-2/5 bg-[#F9F9F9] w-full sm:flex-row flex-col mx-auto px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 items-end">
          ...
          <input
                  ...
                  id="footer-field"
                  name="footer-field"
                  className="w-80 ml-5 font-[Santoshi] text-white bg-[#FFFFFF26] border-0 focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base outline-none py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                />
          </div>
